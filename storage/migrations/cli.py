...
Usage:
    ...
    python -m storage.migrations list

    # Export data (before migration)
    python -m storage.migrations export signals.db backup.json

    # Import data (after migration)
    python -m storage.migrations import backup.json signals.db
...
def print_usage():
    ...
    print("""
Usage: python -m storage.migrations <command> [args]
...
Examples:
    ...
    python -m storage.migrations export signals.db backup.json
    python -m storage.migrations import backup.json signals_new.db
    python -m storage.migrations validate signals.db
