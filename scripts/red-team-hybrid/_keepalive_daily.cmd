...
call "python" run_pipeline.py collect --collectors hacker_news,arxiv,rss_feeds
set "KEEPALIVE_COLLECT_EXIT=%ERRORLEVEL%"
call "python" scripts/red-team-hybrid/freshness_watchdog.py --json --threshold-hours 36 --operational hacker_news,arxiv,rss_feeds --min-created-at "%KEEPALIVE_RUN_START_UTC%" > "%KEEPALIVE_WATCHDOG_ARTIFACT%"
