# Reference: quality-export-dataset

## Primary entrypoints

### Ops CLI

- `python -m ops.cli quality export --days 90 --format csv --out /tmp/quality.csv`

### Scripts (wrappers)

- `scripts/quality/export_quality_dataset.py`
