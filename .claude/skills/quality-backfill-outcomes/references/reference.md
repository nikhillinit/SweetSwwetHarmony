# Reference: quality-backfill-outcomes

## Primary entrypoints

### Ops CLI

- `python -m ops.cli quality backfill-outcomes --days-to-count 30`

### Scripts (wrappers)

- `scripts/quality/backfill_quality_outcomes.py`
